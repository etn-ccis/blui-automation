...
const calcAutomationPercentage = (unitTests, manualTests) =>
    ((unitTests / ((unitTests + manualTests))) * 100).toFixed(2);

axios.all([
    axios.get('https://raw.githubusercontent.com/brightlayer-ui/angular-workflows/feature/validation/login-workflow/VALIDATION.md')
    ...
    console.log(`Aggregate Test Automation Percentage: ` + calcAutomationPercentage(platformUnitTestCount, platformManualTestCount));
